  ...
  var getCateList = function (maintainer, repo) {
    ...
    if (!isAwesome) {
      var originRepoHTML =
        '<a href="' +
        repoURL +
        '" class="origin-repo-btn" target="_blank">View on <i class="fa fa-github"></i></a><a href="https://github.com/lockys/awesome-search/issues/new" target="_blank" class="origin-repo-btn"><i class="fa fa-exclamation-circle"></i> Create an issue about this Repo</a><br/><br/>';
